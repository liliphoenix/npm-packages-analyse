...
function setLabelStyle(targetEl, labelStatesModels, opt, stateSpecified // TODO specified position?
  ...
  if (needsCreateText) {
    ...
    if (textContent.style.x != null) {
      ...
      // versionStyle.x = textContent.style.x;
      // circularStyle.x = textContent.style.x;
    }

    if (textContent.style.y != null) {
      normalStyle.y = textContent.style.y;
      // versionStyle.y = textContent.style.y;
      // circularStyle.y = textContent.style.y;
    }

    textContent.ignore = !showNormal; // Always create new style.

    textContent.useStyle(normalStyle);
    // textContent.useStyle(versionStyle);
    // textContent.useStyle(circularStyle);
    textContent.dirty();
